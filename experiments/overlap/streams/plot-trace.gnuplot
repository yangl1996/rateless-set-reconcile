...
plot 'log1.txt' u ($1/1000.0):($2*1000.0) w lines axes x1y1 title "Node A Codeword" lw 2 lt 1, \
     'log1.txt' u ($1/1000.0):($3*1000.0) w lines axes x1y1 title "Node B Codeword" lw 2 lt 2, \
     'log1.txt' u ($1/1000.0):4 w lines axes x1y2 title "Node A Loss" lw 2 lt 3, \
     'log1.txt' u ($1/1000.0):5 w lines axes x1y2 title "Node B Loss" lw 2 lt 4, \
